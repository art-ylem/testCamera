...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        plusHelper.setOnClickListener(v -> incrementZoom());
        minusHelper.setOnClickListener(v -> decrementZoom());
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        ...
        if (keyCode == 1 && event.getAction() == KeyEvent.ACTION_UP) {
            Log.e("TAG", "onKeyUp: 1 ");
            incrementZoom();
        }
        if (keyCode == 2 && event.getAction() == KeyEvent.ACTION_UP) {
            Log.e("TAG", "onKeyUp: 2 ");
            decrementZoom();
        }
        return true;
